...
export default function ScrapeView() {
    ...
    const getPrerequisitesForSingleCourse = (singleCourse: string) => {
        ...
        if (courses.get(singleCourse) != null) { // Delete this after sprint 4 user interviews
            coursePrerequisites = courses.get(singleCourse); // Delete this after sprint 4 user interviews
